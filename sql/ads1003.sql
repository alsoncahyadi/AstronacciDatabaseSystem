...
CREATE TABLE `aclub_members` (
  ...
  CONSTRAINT `aclub_members_master_id_foreign` FOREIGN KEY (`master_id`) REFERENCES `aclub_informations` (`master_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2018-03-22 10:03:25
