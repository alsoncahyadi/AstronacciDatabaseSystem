...
INSERT INTO `assign_green` VALUES (1,1,'username','CAT','2017-01-15','admin_username','2017-01-15 12:35:16','keterangan lainnya','2017-01-15 12:38:00',NULL,NULL);
...
INSERT INTO `assign_redclub` VALUES (1,'Ramos','username','CAT','2017-01-15','keterangan','admin_username','2017-01-15 12:39:06','0000-00-00 00:00:00',NULL,NULL);
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `edit_assign_green`(
         ...
         IN var_is_succes         boolean,
         IN var_prospect_date    date
    )
BEGIN
        UPDATE assign_green
        SET
        ...
        prospect_date = var_prospect_date
...
-- Dump completed on 2017-01-15 19:45:17
